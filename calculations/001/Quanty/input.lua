...
if H_magnetic_field == 1 then
    Bx_i = 0.0004 / math.sqrt(3)
    By_i = 0.0004 / math.sqrt(3)
    Bz_i = 0.0004 / math.sqrt(3)

    Bx_f = 0.0004 / math.sqrt(3)
    By_f = 0.0004 / math.sqrt(3)
    Bz_f = 0.0004 / math.sqrt(3)
...
k = {1 / math.sqrt(3), 1 / math.sqrt(3), 1 / math.sqrt(3)}
ev = {1 / math.sqrt(6), 1 / math.sqrt(6), -2 / math.sqrt(6)}
eh = {3 / math.sqrt(18), -3 / math.sqrt(18), 0}
