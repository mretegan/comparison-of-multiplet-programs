...
if H_3d_4p_hybridization == 1 then
	...
	Vt2_3d_4p_i = 15 / math.sqrt(21) -- see discussion in appendinx.

	Vt2_3d_4p_f = 15 / math.sqrt(21)
...
if H_magnetic_field == 1 then
    Bx_i = 0.0
    By_i = 0.0
    Bz_i = 0.0 -- 1.1920928955078125e-07

    Bx_f = 0.0
    By_f = 0.0
    Bz_f = 0.0 -- 1.1920928955078125e-07
...
T = 1.0 * EnergyUnits.Kelvin.value
...
Emin = (7111.0 - Eedge1) + DeltaE
Emax = (7151.0 - Eedge1) + DeltaE
NE = 2000
Gamma = 0.1
DenseBorder = 2000
...
if H_3d_4p_hybridization == 1 then
    ...
    print(prefactor_1s_3d)
    print(prefactor_1s_4p)
...
if H_3d_4p_hybridization == 1 then
    ...
    if ValueInTable(spectrum, spectra) then
        ...
        SaveSpectrum(Giso_1s_3d, 'iso_quad')

        Giso_1s_4p = Giso_1s_4p / 3
        SaveSpectrum(Giso_1s_4p, 'iso_dip')

        Giso_1s_3d = prefactor_1s_3d * Giso_1s_3d 
        SaveSpectrum(Giso_1s_3d, 'iso_quad_scaled')

        Giso_1s_4p = prefactor_1s_4p * Giso_1s_4p
        SaveSpectrum(Giso_1s_4p, 'iso_dip_scaled')
