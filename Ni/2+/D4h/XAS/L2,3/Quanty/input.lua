...
if H_atomic == 1 then
    ...
    F2_3d_3d_f = 12.234 * 0.8
    F4_3d_3d_f = 7.598 * 0.8
...
if H_magnetic_field == 1 then
    Bx_i = 0.0 * EnergyUnits.Tesla.value
    By_i = 0.0 * EnergyUnits.Tesla.value
    Bz_i = 0.0 * EnergyUnits.Tesla.value

    Bx_f = 0.0 * EnergyUnits.Tesla.value
    By_f = 0.0 * EnergyUnits.Tesla.value
    Bz_f = 0.0 * EnergyUnits.Tesla.value
...
Operators = {H_f, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_2p, N_3d}
header = 'Analysis of the initial Hamiltonian:\n'
header = header .. '=============================================================================================================\n'
header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>    <N_2p>    <N_3d>          dZ\n'
header = header .. '=============================================================================================================\n'
...
if H_3d_Ld_hybridization == 1 then
    ...
    header = header .. '===========================================================================================================\n'
    header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>    <N_2p>    <N_3d>    <N_Ld>\n'
    header = header .. '===========================================================================================================\n'
    footer = '===========================================================================================================\n'
end
